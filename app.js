...
function generateEquipmentData() {
  ...
  const rarities = ['Commun', 'Peu_commun', 'Rare', 'Épique', 'Légendaire', 'Mythique', 'Divin', 'Primordial', 'Éternel', 'Céleste', 'Interstellaire'];
  ...
  const totalPossibilities = equipmentTypes.length * possibilityNames * rarities.length * qualities.length * 20;
...
const renderIndexPage = () => {
  ...
  checkIfOwned();
  const valideRarity = ['Mythique', 'Divin', 'Primordial', 'Éternel', 'Céleste', 'Interstellaire'];

  currentPageItems.forEach(item => {
    const itemDiv = document.createElement('div');
    itemDiv.className = `${valideRarity.includes(item.rarity) && item.owned ? '' : 'bg-gray-800'} rounded p-3 flex flex-col items-center relative`;
    itemDiv.style = `${valideRarity.includes(item.rarity) && item.owned
      ? `background: linear-gradient(rgba(255,255,255,0.5),${addOpacity(rarityColors[item.rarity], 0.5)});`
      : ''
      }`
    ...
    if (!item.owned) {
      ...
      const starColor = item.rarity === 'Primordial' ? '#00ffff' : item.rarity === 'Éternel' ? '#ff00ff' : item.rarity === 'Céleste' ? '#280f3d' : item.rarity === 'Divin' ? '#ffd700' : item.rarity === 'Mythique' ? '#e01a6b' : '#ffcc00'
      ...
      const itemStars = document.createElement('div');
      itemStars.className = 'text-xs';
      const starColor = item.rarity === 'Interstellaire' ? '#000000' : item.rarity === 'Primordial' ? '#00ffff' : item.rarity === 'Éternel' ? '#ff00ff' : item.rarity === 'Céleste' ? '#280f3d' : item.rarity === 'Divin' ? '#ffd700' : item.rarity === 'Mythique' ? '#e01a6b' : '#ffcc00'
...
const renderEquipment = (equipment) => {
  ...
  let html = `<div class="p-6 mt-12 rounded-lg shadow-lg relative glowing-image-${(equipment.rarity).toLowerCase()} ${valideRarity.includes(equipment.rarity) ? '' : 'bg-gray-800'}" style="z-index:1; ${valideRarity.includes(equipment.rarity)
    ? `background: linear-gradient(rgba(255,255,255,0.5),${addOpacity(rarityColors[equipment.rarity], 0.5)});`
    : ''
    }">`;

  // Ajoute le powerScore en bas à gauche   
  html += `
    <div style="box-shadow: inset 0 -10px 10px -10px ${rarityColors[equipment.rarity]};" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg bg-gray-800 mb-14">
      <span class="text-yellow-400 font-bold glowing-image-${(equipment.rarity).toLowerCase()}" style="color:${rarityColors[equipment.rarity]}">Power: ${equipment.powerScore}</span>
    </div>
  `;
  ...
  if (equipment.rarity == 'Mythique') {
    ...
    html += ` <div class="ml-4 absolute ${valideRarity.includes(equipment.rarity) ? 'bg-white' : 'bg-gray-800'} p-6" style="border-radius:50%; top:-30px; right:-30px;">
  ...
  if (equipment.attack !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #195F53;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-green-500 bg-gray-800">
  ...
  if (equipment.defense !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #4287f5;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-blue-500 bg-gray-800">
  ...
  if (equipment.magic !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #7C55DB;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-purple-500 bg-gray-800">
  ...
  if (equipment.strength !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #C13E41;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-red-500 bg-gray-800">
  ...
  if (equipment.agility !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #30B98A;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-green-400 bg-gray-800">
  ...
  if (equipment.intelligence !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #5999E6;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-blue-400 bg-gray-800">
  ...
  if (equipment.vitality !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #A6731C;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-yellow-500 bg-gray-800">
  ...
  if (equipment.critChance !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #D5A527;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-yellow-400 bg-gray-800">
  ...
  if (equipment.critDamage !== undefined) {
    html += `
          <div style="box-shadow: inset 0 -10px 13px -10px #ffffff;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-white bg-gray-800" style="box-shadow: inset 0 -10px 13px -10px #fff;">
  ...
  html += `
          ...
          <div class="border-t border-gray-700 pt-3 mb-12">
            <div style="box-shadow: inset 0 -10px 13px -10px #ffffff;" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg mb-2 bg-gray-800">
            ...
            <div style="box-shadow: inset 0 -10px 13px -10px rgb(129, 108, 42);" class="flex justify-left border-l pl-2 border-b pb-2 border-r border-t pt-2 rounded-lg border-yellow-300 bg-gray-800">
